...
class TestEditorTopics:
    ...
    def test_init(self):
        ...
        assert isinstance(target._ui_topics, VOUTLINE_ID.UiDisplayOutlineId)
        assert N_COLUMNS == target._ui_topics.get_n_columns()
    ...
    def test_init_signal_change(self):
        ...
        target = VTOPICS.EditorTopics(p_control_sheet=control_sheet)
        # Test
        attribute = target._ui_topics.get_selection()
        n_handlers = 0
        while True:
    ...
    def test_on_changed_selection_in(self):
        ...
        ui_model_topics = target._ui_topics.get_model()
        ...
        target._ui_topics.expand_all()
        ui_selection = target._ui_topics.get_selection()
        # Test
        ui_selection.select_iter(line_topic)
    ...
    def test_on_changed_selection_warn(self, monkeypatch, caplog):
        ...
        # Test
        ui_selection.select_iter(line_trigger)
        name_visible = target._views_topics.ui_view.get_visible_child_name()
        assert target._name_view_default == name_visible
    ...
    def test_on_delete_topic(self):
        ...
        ui_selection.get_tree_view().expand_all()
        ui_selection.select_iter(line_delete)
