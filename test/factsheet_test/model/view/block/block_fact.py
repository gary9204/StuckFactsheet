"""
Defines class to display fact in a topic form.  See :mod:`.form_topic`.
"""
...
class BlockFact(ABC_FACT.InterfaceBlockFact[ValueOpaque]):
    ...
    Class ``BlockFact`` displays a fact in a component of a topic form.
...
#         self.select_aspect(self._name_default)
    ...
    def on_show_dialog(self):
        ...
        .. note:: **Enhancement opportunity**
           ...
           topic form is in a top-level window.
