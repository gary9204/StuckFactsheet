...
.. data:: AttachViewTopics

    Type hint for function to connect view of topics outline to model.
...
.. data:: FACTORY_TOPIC
    ...
    and :class:`.FormTopic`.   See :mod:`.abc_factory`.
