...
from factsheet.content.ops.int import spec_plusmodn as XSPEC_PLUS_N
from factsheet.content.ops.int import topic_plusmodn as XPLUS_N
from factsheet.content.sets.int import topic_segint as XSEGINT
from factsheet.content.sets.int import topic_setint as XSETINT
...
class TestSpecPlusModN:
    ...
    def test_call_apply(self, patch_args_spec, monkeypatch):
        ...
        # Sync identification information with spec_plusmodn.ui.
        NAME = ''
        SUMMARY = ''
        TITLE = ''
        MODULUS = 2
        SET = XSEGINT.SegInt(p_bound=MODULUS)
        REPS = {0: XSETINT.ElementInt(0, 0),
                1: XSETINT.ElementInt(1, 1),
                }
