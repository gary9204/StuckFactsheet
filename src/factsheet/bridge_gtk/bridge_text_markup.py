...
class PairViewDuoTextMarkup:
    ...
    The view contains a display and an editor for markup text.  Display
    shows formatted text when markup is valid.  It shows text with
    embedded markup when there is a markup error.  User can popup editor
    to edit both text and embedded markup.  The formatted text in the
    display updates as the user edits the markup text.  User can cancel
    edit and discard changes.
    """
    ...
    def __init__(
        ...
        """
        pass
        # builder = Gtk.Builder.new_from_string(self._UI_VIEW_DUO, -1)
    ...
    # @property
    def ui_model(self) -> UiTextMarkup:
