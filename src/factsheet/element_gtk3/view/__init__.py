"""
Facade classes for GTK 3 visual elements.

Each facade class provides a view of a mod

Each facade class provides a view of storage element.  See
:mod:`.factsheet.element_gtk3`.
